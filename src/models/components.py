...
def get_backbone(name, input_channels=None):
    """
...
def get_rpn(
    ...
    rpn_head = RPNHead(backbone_out_channles, rpn_anchor_generator.num_anchors_per_location()[0])
